...
const HistoryPost = ({ data, onClose  }) => {
  ...
  return (
      <div className="floating-history-comment-floating-history-comment">
        <div className="floating-history-comment-history-floating-window-expanded-comment">
        <img
            src={close}
            alt="닫기"
        ...
        {/* -------------게시글------------ */}
          <span className="floating-history-comment-text065">
            <span>History</span>
          </span>
          <span className="floating-history-comment-text067">
            <span>{data.title}</span>
          </span>
          <div id='작성자 정보' className="floating-history-comment-frame28">
        ...
        <div style={{ overflow:"auto"}}>
          ...
          {/* -------------해시태그------------ */}
        <div  id='해시태그' className="floating-history-comment-frame">
        ...
        {/* ------------댓글------------- */}
          <div id='댓글 컨테이너' className="floating-history-comment-frame01">
            <div id='댓글 컨텐츠' className="floating-history-comment-frame02">
                <div  id='좋아요' className="floating-history-comment-frame04">
                    <img
                        src={like}
                        alt="좋아요"
              ...
              <div  id='댓글 작성자' className="floating-history-comment-frame03">
              <img
                  src={user3}
                  alt="댓글 작성자 프로필이미지"
                  className="floating-history-comment-freeiconuser1490711"
                />
                <span id='사용자 아이디' className="floating-history-comment-text006">
                  <span>{data.memberId}</span>
                </span>
              </div>
              <span  className="floating-history-comment-text008">
                <span>댓글 내용</span>
              </span>
          ...
          <div id='답글 컨테이너' className="floating-history-comment-frame19">
            <div className="floating-history-comment-frame14">
                <img
                    src={like}
                    alt="좋아요"
            ...
            <div id='답글 컨텐츠' className="floating-history-comment-frame12">
         ...
         {/* ------------댓글 작성칸------------- */}
          ...
          <div className="floating-history-comment-group45">
            <div
              className="floating-history-comment-rectangle39"
            />
            <div className="floating-history-comment-group36">
            ...
            />
                ...
                <div className="floating-history-comment-frame25">
